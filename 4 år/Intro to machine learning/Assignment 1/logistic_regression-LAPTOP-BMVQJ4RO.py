...
class LogisticRegression:
    def __init__(self, learning_rate=0.01, epochs=1000):
        ...
        self.losses = []  # Initialize as an empty list
        self.train_accuracies = []  # Initialize as an empty list
        self.threshold = 0.5
    ...
    def compute_gradients(self, x, y, y_pred):
        ...
        # Create quadratic and interaction terms (since linear clearly failed for us)
