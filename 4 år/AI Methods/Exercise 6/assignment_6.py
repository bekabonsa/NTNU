...
def build_model(cnn=True):
    ...
    if not cnn:
        ...
        # Helps generalize better (minimal impact)
        ...
        model.add(keras.layers.Dropout(0.2)) #Helps generalize better (randomly deactivates neurons during training to prevent overfitting)
